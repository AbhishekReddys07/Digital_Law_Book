      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8 xl:col-span-1">
            <div className="flex items-center">
              ...
              <span className="ml-3 text-2xl font-serif font-bold">Digital Law Book</span>
            </div>
            <p className="text-gray-300 text-base">
              A comprehensive digital platform for legal information, designed for law students, legal professionals, and the general public.
            </p>
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                ...
                <ul className="mt-4 space-y-4">
                  <li>
                    <Link to="/laws" className="text-base text-gray-300 hover:text-white">
                      Browse Laws
                    </Link>
                  </li>
                  <li>
              ...
              <div className="mt-12 md:mt-0">
                ...
                <ul className="mt-4 space-y-4">
                  ...
                  <li>
                    <Link to="/accessibility" className="text-base text-gray-300 hover:text-white">
                      Accessibility
                    </Link>
                  </li>
                </ul>
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              ...
              <div className="mt-12 md:mt-0">
                ...
                <ul className="mt-4 space-y-4">
                  ...
                  <li>
                    <Link to="/contribute" className="text-base text-gray-300 hover:text-white">
                      Contribute
                    </Link>
                  </li>
                </ul>
        ...
        <div className="mt-12 border-t border-gray-700 pt-8">
          <p className="text-base text-gray-400 xl:text-center">
            &copy; {currentYear} Digital Law Book. All rights reserved. Made with <Heart className="inline-block h-4 w-4 text-burgundy-500" /> by Law Tech Innovations.
          </p>
        </div>
      </div>
    </footer>
